...
RSpec.describe TopicsController, type: :controller do
  ...
  context "logged in user doing CRUD on a topic they do not own" do
    before do
  ...
  context "logged in user doing CRUD on a topic they own" do
    before do
      my_user.confirm
      sign_in my_user
    end
  ...
  context "admin doing CRUD on a topic they do not own" do
    before do
      admin_user = User.create!(username: "Admin User", email: "admin@example.com", password: "helloworld", password_confirmation: "helloworld", admin: true)
      admin_user.confirm
      sign_in admin_user
    end
